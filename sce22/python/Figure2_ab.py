...
ax.set_xlabel(r'$\mathrm{CT}$ (nm)', fontsize=10,labelpad = 0)
...
fig.subplots_adjust(top=0.90)
fig.subplots_adjust(right=0.90)
ax.scatter(filtered_X_CT10_40nm, filtered_nCT10_40nm, s=5, color='#12cbc5', alpha=0.8 ,label = '$\mathrm{D_c}$ = 50-60 nm')
ax.scatter(filtered_X_CT40_70nm, filtered_nCT40_70nm, s=5, color='#1593c3', alpha=0.8 ,label = '$\mathrm{D_c}$ = 60-70 nm')
ax.scatter(filtered_X_CT70_100nm, filtered_nCT70_100nm, s=5, color='#0452d7', alpha=0.8 ,label = '$\mathrm{D_c}$ = 70-80 nm')
ax.scatter(filtered_X_CT100_130nm, filtered_nCT100_130nm, s=5, color='#1c1464', alpha=0.8 ,label = '$\mathrm{D_c}$ = 80-90 nm')

ax.plot(x10_40nm,y10_40nm,color = '#12cbc5',linestyle = '--')
ax.plot(x40_70nm,y40_70nm,color = '#1593c3',linestyle = '--')
ax.plot(x70_100nm,y70_100nm,color = '#0452d7',linestyle = '--')
ax.plot(x100_130nm,y100_130nm,color = '#1c1464',linestyle = '--')
