...
#exit()
#plot1
FigureName = 'Figure1_b'
fig, ax = plt.subplots(figsize=(7, 3),constrained_layout=False)
fig.subplots_adjust(bottom=0.15)
fig.subplots_adjust(left=0.1)
fig.subplots_adjust(bottom=0.15)
fig.subplots_adjust(right=0.95)
ax.plot(plot_X, plot_k , color='#0452d7',label = '$\mathrm{k}$')
ax.plot(plot_X1, plot_k_mv , color='#0452d7',linestyle='--',alpha=0.6,label = 'moving averaged $\mathrm{k}$')
...
ax.set_ylabel(r"Slope of CT distribution", fontsize=10)
